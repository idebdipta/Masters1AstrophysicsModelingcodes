...
void ShowOpticalDepth( 
	...
	double f_evol2_1 = 0,//Evolution parameter
	double f_evol2_2 = 2,//Evolution parameter
	double f_evol2_3 = 4,//Evolution parameter
	double f_evol1 = 2,//Evolution parameter
...
//////////// COMPUTATION ////////////////////////////////////////////////////////////////
	...
	std::vector< std::vector<double> > vKernel2_1;//Kernel12 defined in Biteau and Williams 2015
	Model_InitializeKernel(omegaM, omegaLambda, f_evol2_1, zmax, veGamma, vEgamma, ve,  vzsteps, vKernel2_1);

	std::vector< std::vector<double> > vKernel2_2;//Kernel12 defined in Biteau and Williams 2015
	Model_InitializeKernel(omegaM, omegaLambda, f_evol2_2, zmax, veGamma, vEgamma, ve,  vzsteps, vKernel2_2);

	std::vector< std::vector<double> > vKernel2_3;//Kernel12 defined in Biteau and Williams 2015
	Model_InitializeKernel(omegaM, omegaLambda, f_evol2_3, zmax, veGamma, vEgamma, ve,  vzsteps, vKernel2_3);
...
std::vector< double > vOpacity_3 = Compute_Opacity(vlambda,vnuInu, utils_Interpolate(vKernel,vzsteps,ztest3),H0, ve, veGamma);//Optical depth vs z vs E
	...
	std::vector< double > vOpacity12_11ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest1), utils_Interpolate(vKernel2_1,vzsteps,ztest1),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_21ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest1), utils_Interpolate(vKernel2_2,vzsteps,ztest1),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_31ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest1), utils_Interpolate(vKernel2_3,vzsteps,ztest1),H0, ve, veGamma, lambda0);


	//z=z1=0.2//////////////////////////////
	std::vector< double > vOpacity12_12ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest2), utils_Interpolate(vKernel2_1,vzsteps,ztest2),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_22ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest2), utils_Interpolate(vKernel2_2,vzsteps,ztest2),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_32ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest2), utils_Interpolate(vKernel2_3,vzsteps,ztest2),H0, ve, veGamma, lambda0);


	//z=z1=1//////////////////////////////
	std::vector< double > vOpacity12_13ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest3), utils_Interpolate(vKernel2_1,vzsteps,ztest3),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_23ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest3), utils_Interpolate(vKernel2_2,vzsteps,ztest3),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_33ev2 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest3), utils_Interpolate(vKernel2_3,vzsteps,ztest3),H0, ve, veGamma, lambda0);//Optical depth vs z vs E
...
//**************************************
		//Load the optical depth at ztests for fevol1
	std::vector< double > vOpacity12_1ev1 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest1), utils_Interpolate(vKernel1,vzsteps,ztest1),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_2ev1 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest2), utils_Interpolate(vKernel1,vzsteps,ztest2),H0, ve, veGamma, lambda0);

	std::vector< double > vOpacity12_3ev1 = Compute_Opacity12(vlambda,vnuInu, utils_Interpolate(vKernel1,vzsteps,ztest3), utils_Interpolate(vKernel1,vzsteps,ztest3),H0, ve, veGamma, lambda0);//Optical depth vs z vs E
	/////////////////////////////////////////////////////////////////////
...
//////****fevol@_1///////////
//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E1z1 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_11ev2[0]);
		Gopt_vs_E1z1->SetLineWidth(4);
		Gopt_vs_E1z1->SetLineStyle(2);
		Gopt_vs_E1z1->SetLineColor(kGreen);

//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E2z1 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_21ev2[0]);
		Gopt_vs_E2z1->SetLineWidth(4);
		Gopt_vs_E2z1->SetLineStyle(10);
		Gopt_vs_E2z1->SetLineColor(kRed);

//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E3z1 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_31ev2[0]);
...
//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E1z2 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_12ev2[0]);
		Gopt_vs_E1z2->SetLineWidth(4);
		Gopt_vs_E1z2->SetLineStyle(2);
		Gopt_vs_E1z2->SetLineColor(kGreen);

//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E2z2 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_22ev2[0]);
...
//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E3z2 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_32ev2[0]);
...
//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E1z3 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_13ev2[0]);
		Gopt_vs_E1z3->SetLineWidth(2);
		Gopt_vs_E1z3->SetLineStyle(2);
		Gopt_vs_E1z3->SetLineColor(kGreen);

//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E2z3 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_23ev2[0]);
		Gopt_vs_E2z3->SetLineWidth(2);
		Gopt_vs_E2z3->SetLineStyle(10);
		Gopt_vs_E2z3->SetLineColor(kRed);


//Load the graph of the optical depth vs energy (in log-log space)
	TGraph* Gopt_vs_E3z3 = new TGraph(vEgamma.size(), &vEgamma[0], &vOpacity12_33ev2[0]);
		Gopt_vs_E3z3->SetLineWidth(2);
...
//////////for fevol and fevol2_1, fevol2_2, fevol2_3, total of 9 combination as there are also 3 z values************///////////////
		std::stringstream ssk1_1;
		ssk1_1<<"f_{evol 2} = "<<f_evol2_1;
		leg1->AddEntry(Gopt_vs_E1z1,ssk1_1.str().c_str(),"l");


		std::stringstream ssk1_2;
		ssk1_2<<"f_{evol 2} = "<<f_evol2_2;
		leg1->AddEntry(Gopt_vs_E2z1,ssk1_2.str().c_str(),"l");

		std::stringstream ssk1_3;
		ssk1_3<<"f_{evol 2} = "<<f_evol2_3;
...
//		c1->cd()->SetLogy();
		...
		tl.DrawLatex(0.3,0.94,"f_{evol 1} = 2, Varying f_{evol 2}, #lambda_{cut} = 10 #mum");
